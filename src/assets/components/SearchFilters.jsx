...
function SearchFilters(props) {
    ...
    return (
        <div className='bg-white '>
            <form className='space-x-5 p-2'>
                {/* <div className='w-[70%]'>
                    ...
                    <input className='w-full' type="range" id="salary" name="salary" min={0} max={800000} step={10000} />
                </div> */}
        ...
        {(Number(minSalaryRange) || Number(maxSalaryRange))?<IoCloseCircleSharp onClick={resetValues} className='ml-auto m-1 text-red-500 size-5'/>: ""}
        </div>
    )
}
